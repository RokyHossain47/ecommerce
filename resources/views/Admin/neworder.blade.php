                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>&#36; 200</td>
                                <td>Received</td>
                                <td> <a class="shadow" href="{{route('updateorder')}}"><i class="fas fa-eye btn btn-primary "></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
                                ...
                                <td>&#36; 100</td>
                                <td>Pending</td>
                                <td> <a class="shadow" href="{{route('updateorder')}}"><i class="fas fa-eye btn btn-primary shadow"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>3</td>
